...
path_to_parent_directory = "/srv/data/RQE/entanglementStudyData"

parameters_tested_path = os.path.join(path_to_parent_directory, "parameters_tested.csv")

df = pd.read_csv(parameters_tested_path)